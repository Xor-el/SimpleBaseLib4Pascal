...
class function TBinaryPrimitives.ReadDoubleLittleEndian(const AData: TSimpleBaseLibByteArray; AOffset: Integer): Double;
var
  LBits: UInt64;
begin
  CheckBounds(AData, AOffset, SizeOf(Double));
...
class function TBinaryPrimitives.ReadDoubleBigEndian(const AData: TSimpleBaseLibByteArray; AOffset: Integer): Double;
var
  LBits: UInt64;
begin
  CheckBounds(AData, AOffset, SizeOf(Double));
